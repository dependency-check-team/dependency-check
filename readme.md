...
[![Build Status](https://travis-ci.com/dependency-check-team/dependency-check.svg?branch=2.x)](https://travis-ci.com/dependency-check-team/dependency-check)
[![Known Vulnerabilities](https://snyk.io/test/github/dependency-check-team/dependency-check/2.x/badge.svg?targetFile=package.json)](https://snyk.io/test/github/dependency-check-team/dependency-check/2.x?targetFile=package.json)
